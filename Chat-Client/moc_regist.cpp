...
static const char qt_meta_stringdata_regist[] = {
    "regist\0\0on_pushButton_2_clicked()\0"
...
const QMetaObjectExtraData regist::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject regist::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_regist,
      qt_meta_data_regist, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &regist::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_regist))
