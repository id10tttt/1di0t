...
static const char qt_meta_stringdata_question[] = {
    "question\0\0data\0send(QString)\0"
    "on_pushButton_clicked()\0"
    "on_pushButton_2_clicked()\0"
    "receivedata(QString)\0"
};
...
const QMetaObjectExtraData question::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject question::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_question,
      qt_meta_data_question, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &question::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_question))
...
// SIGNAL 0
void question::send(QString _t1)
{
