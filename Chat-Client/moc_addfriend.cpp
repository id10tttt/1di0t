...
static const char qt_meta_stringdata_addfriend[] = {
    "addfriend\0\0on_pushButton_clicked()\0"
};
...
const QMetaObjectExtraData addfriend::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject addfriend::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_addfriend,
      qt_meta_data_addfriend, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &addfriend::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_addfriend))
